...
// Constants
// ------------------------------------
export const GET_KOMPENSASI_START = 'GET_KOMPENSASI_START'
export const GET_KOMPENSASI_SUCCESS = 'GET_KOMPENSASI_SUCCESS'
...
// ------------------------------------
function getKompensasiStart () {
  return {
    type: GET_KOMPENSASI_START
  }
}
function getKompensasiFinish (result) {
  return {
    type: GET_KOMPENSASI_SUCCESS,
    data: result
  }
}
export function getKompensasi () {
  return (dispatch) => {
    dispatch(getKompensasiStart())
    return fetch(API_URL + 'kompensasi/', {
      method: 'get',
      headers: {
    ...
    .then((json) => dispatch(getKompensasiFinish(json)))
  }
}
...
export default function kompensasiReducers (state = initialState, action) {
  switch (action.type) {
    case GET_KOMPENSASI_START:
      return Object.assign({}, state, {
        isLoadingData: true,
        isRequestingUserData: true
      })
    case GET_KOMPENSASI_SUCCESS:
      return Object.assign({}, state, {
        isLoadingData: false,
        data: action.data
      })
